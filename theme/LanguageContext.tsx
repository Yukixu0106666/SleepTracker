...
const translations = {
  en: {
    ...
    morningReport: 'Morning Report', predictedGood: 'Likely good sleep', predictedPoor: 'Likely poor sleep', goodSleepLikelihood: 'Good-sleep likelihood', whyThisEstimate: 'Why this estimate?', hideModelDetails: 'Hide model details', modelSignals: 'Model signals', durationSignal: 'Sleep duration', ageSignal: 'Age', bmiSignal: 'BMI category', positiveSignal: 'supported the estimate', negativeSignal: 'lowered the estimate', modelMethod: 'Compact Logistic Regression using sleep duration, age, and BMI category.', modelValidation: 'Development validation: 0.960 macro-F1 with grouped 5-fold cross-validation.', modelDisclaimer: 'A portfolio estimate from public development data—not a medical assessment or causal explanation.', predictedTrend: 'Model-assisted quality trend', noPredictionTrend: 'Complete a sleep session to see quality estimates.',
  ...
  zh: {
    ...
    morningReport: '晨间睡眠报告', predictedGood: '睡眠质量预计良好', predictedPoor: '睡眠质量预计偏低', goodSleepLikelihood: '良好睡眠可能性', whyThisEstimate: '为什么是这个结果？', hideModelDetails: '收起模型说明', modelSignals: '模型信号', durationSignal: '睡眠时长', ageSignal: '年龄', bmiSignal: 'BMI 分类', positiveSignal: '支持了该预测', negativeSignal: '降低了该预测', modelMethod: '精简 Logistic Regression，使用睡眠时长、年龄和 BMI 分类。', modelValidation: '开发集验证：grouped 5-fold 交叉验证 macro-F1 为 0.960。', modelDisclaimer: '这是基于公开开发数据的作品集估计，不是医疗评估或因果解释。', predictedTrend: '模型辅助的睡眠质量趋势', noPredictionTrend: '完成一次睡眠记录后即可查看质量估计。',
